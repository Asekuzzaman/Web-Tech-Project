...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['days'])) {
        ...
        // Save rental details to the database (optional)
        $query = "INSERT INTO rentals (username, name, category, days, total_cost, payment_method)
                  VALUES ('$username', '{$rental_details['name']}', '{$rental_details['category']}', '{$rental_details['days']}', '{$rental_details['total_cost']}', '$payment_method')";
...
<head>
    ...
    <link rel="stylesheet" href="../../css/laptop/laptop.css"> <!-- If using external CSS file -->
</head>
<body>
    <div class="confirmation-container">
        <h1>Laptop Rental Confirmation</h1>
...
<table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
    ...
    <tbody>
        ...
        <tr>
            <td style="padding: 10px; border: 1px solid #ddd;">Laptop Name</td>

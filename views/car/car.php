...
<header id="header">
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li><a href="../renterDash.php#home">Home</a></li>
            <li><a href="../renterDash.php#services">Services</a></li>
            <li><a href="../renterDash.php#about">About Us</a></li>
...
<div class="filters">
        <form method="POST" action="">
            ...
            <!-- Category Filter -->
             ...
             <h3>Category</h3>
            <label>
                <input type="checkbox" name="category[]" value="SUV" <?php if (in_array('SUV', $categoryFilter)) echo 'checked'; ?>> SUV
            </label>
            <label>
                <input type="checkbox" name="category[]" value="Coupe" <?php if (in_array('Coupe', $categoryFilter)) echo 'checked'; ?>> Coupe
            </label>
            <label>
                <input type="checkbox" name="category[]" value="Cabriolet" <?php if (in_array('Cabriolet', $categoryFilter)) echo 'checked'; ?>> Cabriolet
            </label>
            <label>
                <input type="checkbox" name="category[]" value="Family Car" <?php if (in_array('Family Car', $categoryFilter)) echo 'checked'; ?>> Family Car
            </label>
            <label>
                <input type="checkbox" name="category[]" value="Electric Vehicle" <?php if (in_array('Electric Vehicle', $categoryFilter)) echo 'checked'; ?>> Electric Vehicle
            </label>
           

            <!-- Filter Buttons -->
            <button type="submit">Apply Filter</button>
            <button type="button" onclick="location.href='car.php';">Clear Filter</button>
        </form>
    </div>
    ...
    <main class="car-section">
      ...
      <div class="car-grid">
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <div class="car-card">
                <img src="../../images/<?php echo $row['image']; ?>" alt="<?php echo $row['car_name']; ?>" style="width: 100%;">
